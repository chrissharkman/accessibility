...
public class MainContentHandler {
	...
	public void execute(MApplication app, EModelService modelService, EPartService partService) throws InvocationTargetException, InterruptedException {
		MPerspective myPerspective = (MPerspective) modelService.find("ch.chrissharkman.accessibility.rcp.application.perspective.main", app);
